 ...
 */
public class BjLittlePetSupplierBackOrderedTopicMessageListener implements MessageListener {

    private static final Log log = LogFactory.getLog(BjLittlePetSupplierBackOrderedTopicMessageListener.class);
    ...
    public void onMessage(Message message) {
        try {
            if (message instanceof MapMessage) {
                ...
                log.info("-------- BjLittlePetSupplierBackOrderedTopicMessageListener ---------");
