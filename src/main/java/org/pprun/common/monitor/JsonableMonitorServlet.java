...
/**
 * Servlet print out the {@literal JSON} format of the statistics to response.
 * 
 * @author <a href="mailto:pizhigang@letv.com">pizhigang</a>
 */
public class JsonableMonitorServlet extends HttpServlet {

    private static final Logger log = LoggerFactory.getLogger(JsonableMonitorServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // print out the statistics in JSON to writer of response
            writer = response.getWriter();
            writer.write(monitor.asJson());
